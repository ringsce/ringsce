    ...
    : QMainWindow(parent)
{
...

    {
        ...
        settingsMenu->addAction(tr("Settings"), this, &TextEdit::about);
        //settingsMenu->addAction(tr("Settings")), this, &QApplication::);
        settingsMenu -> addAction(tr("Update"), this, &TextEdit::about);
        QMenu *buildMenu = menuBar() -> addMenu(tr("Build"));
        buildMenu->addAction(tr("Build"), this, &TextEdit::about);
        buildMenu->addAction(tr("Build All"), this, &QApplication::aboutQt);
        QMenu *analyzeMenu = menuBar() -> addMenu(tr("Analyze"));
        analyzeMenu->addAction(tr("Analyze"), this, &TextEdit::about);
        //analyzeMenu->addAction(tr("Profiling"), this, &QApplication::aboutQt);
        QMenu *toolsMenu = menuBar() -> addMenu(tr("Tools"));
        toolsMenu->addAction(tr("Tools"), this, &TextEdit::about);
        toolsMenu->addAction(tr("Plugins"), this, &QApplication::aboutQt);
        QMenu *helpMenu = menuBar()->addMenu(tr("Help"));
        helpMenu->addAction(tr("About Tools"), this, &TextEdit::about);
...
void TextEdit::setupFileActions()
{
    ...
    QAction *a = menu->addAction(newIcon,  tr("&New Project"), this, &TextEdit::fileNew);

    // C - C++ Project
    //const QIcon newIcon = QIcon::fromTheme("document-new", QIcon(rsrcPath + "/filenew.png"));
    //a = menu->addAction(newIcon,  tr("&New File"), this, &TextEdit::fileNew);
    //tb->addAction(a);

    //Pascal Project
    //const QIcon newFileIcon = QIcon::fromTheme("document-new", QIcon(rsrcPath + "/filenew.png"));
    //a = menu->addAction(newFileIcon,  tr("&New File"), this, &TextEdit::fileNew);
    //tb->addAction(a);
    ...
    // Settings
    //const QIcon settingsIcon = QIcon::fromTheme("document-settings", QIcon(rsrcPath + "/settings.png"));
    //actionSettings = menu->addAction(settingsIcon, tr("&Settings"), this, &TextEdit::fileSettings);
    //actionSettings->setShortcut(QKeySequence::Settings);
    //actionSettings->setEnabled(false);
    //tb->addAction(actionSettings);


    actionSave = menu->addAction(saveIcon, tr("&Save All"), this, &TextEdit::fileSave);
    actionSave->setShortcut(QKeySequence::Save);
    actionSave->setEnabled(false);
    tb->addAction(actionSave);
