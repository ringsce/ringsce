...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionBuildAll = new QAction(MainWindow);
        ...
        actionCVS = new QAction(MainWindow);
        ...
        actionAddIns = new QAction(MainWindow);
        ...
        actionGDB_2 = new QAction(MainWindow);
        ...
        actionDepoyWithoutDebugging = new QAction(MainWindow);
        actionDepoyWithoutDebugging->setObjectName(QStringLiteral("actionDepoyWithoutDebugging"));
        actionRun = new QAction(MainWindow);
        actionRun->setObjectName(QStringLiteral("actionRun"));
        actionRunWithoutDeployment = new QAction(MainWindow);
